...
setdiff(List_of_species$specie_name_cites,summary_species$specie_name_cites)

setdiff(summary_species$specie_name_cites,List_of_species$specie_name_cites)
...
```
Entries only found in one table: *Python breitensteini* (filtered from sample list as no sample entry was found)
